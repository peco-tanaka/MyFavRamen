...
「MyFavらぁめん」は、ラーメン愛好家が自分だけのラーメンランキング（"俺ランク"）を作成・共有できるWebアプリケーションです。ユーザーは訪問したラーメン店を記録し、個人的な好みに基づいてランキング付けができます。また、他のユーザーのランキングを閲覧したり、フォローしたりすることで緩やかなSNSコミュニティを形成します。従来の飲食店レビューサイトとは異なり、店舗への評価機能は設けず、あくまで「自分にとってのラーメンランキング」を中心とし、誰も傷つくことのない、ゆるくポジティブな交流の場を提供します。アプリ内でのSNS要素は付加価値の一つであり、一人の利用でもコア機能である「ランキングを作る」楽しさを提供します。
...
- ランキングは総合・醤油・豚骨・味噌などジャンル毎につけることができる
- ドラッグ＆ドロップでの順位変更
